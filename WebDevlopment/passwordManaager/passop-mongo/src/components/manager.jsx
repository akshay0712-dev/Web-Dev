    ...
    <>
      ...
      <div className="bg-gray-100 mycontainer px-0 md:px-40">
        <h1 className="text-4xl font-bold text-center">
          ...
          <span className="font-[cursive,_Verdana,_Geneva,_Tahoma,_sans-serif]">
            Pass
          </span>
              ...
              return (
                ...
                >
                  ...
                  <div className="max-h-[40px] w-full truncate border-[0.5px] px-3 py-2 text-center flex flex-row justify-between">
                    ...
                    <span
                      className="material-symbols-outlined font-bold text-base flex items-center cursor-pointer"
                      title={item.username}
                      onClick={() => {
                        copy(item.username);
                      }}
                  ...
                  <div className="max-h-[40px] w-full truncate border-[0.5px] px-3 py-2 text-center flex flex-row justify-between">
                    <span className="truncate px-2" title={item.password}>
                      {item.password}
                    </span>
                    <span
                      className="material-symbols-outlined font-bold text-base flex items-center cursor-pointer"
